...
def test_removeTopology(triangle_transient_dataset):
    ...
    assert (
        len(triangle_transient_dataset.variables) == 2
    )  # removed face_nodes, mesh2d, node_x and node_y
...
def test_dataset_chaining(triangle_transient_dataset):
    ...
    chained = uds.sel(time=slice("2018-01-01", "2018-01-03")).ugrid.sel_points(
        points_x, points_y
    )
...
def test_data_array_chaining(triangle_transient_dataset):
    ...
    chained = ugda.sel(time=slice("2018-01-01", "2018-01-03")).ugrid.sel_points(
        points_x, points_y
    )
...
def test_create_time_series_from_dataArray_from_slices(triangle_transient_dataset):
    ...
    chained_slice = ugda.sel(time=slice("2018-01-01", "2018-01-03")).ugrid.sel(
        slice(1, 51, 10), slice(2, 52, 10)
    )
    points_x = np.array([1, 11, 21, 31, 41], np.float64)
    points_y = np.array([2, 12, 22, 32, 42], np.float64)
    chained_points = ugda.sel(time=slice("2018-01-01", "2018-01-03")).ugrid.sel_points(
        points_x, points_y
    )
...
def test_create_time_series_from_dataset_from_slices(triangle_transient_dataset):
    ...
    chained_slice = ugds.sel(time=slice("2018-01-01", "2018-01-03")).ugrid.sel(
        slice(1, 51, 10), slice(2, 52, 10)
    )
    points_x = np.array([1, 11, 21, 31, 41], np.float64)
    points_y = np.array([2, 12, 22, 32, 42], np.float64)
    chained_points = ugds.sel(time=slice("2018-01-01", "2018-01-03")).ugrid.sel_points(
        points_x, points_y
    )
