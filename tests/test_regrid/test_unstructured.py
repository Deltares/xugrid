...
class TestUnstructured:
    ...
    def test_init(sel):
        # TODO: different synthetic example. Or remove matplotlib logic.
    ...
    def test_grid_properties(self, circle):
    ...
    def test_overlap(self, circle, relative):
    ...
    def test_locate_centroids(self, circle):
    ...
    def test_barycentric(self, circle):
